...
LIBSSH2_INSTALL_ROOT ?= $(INSTALL_ROOT_nto)/$(NAME)/$(notdir $(QNX_BASE))
...
CMAKE_ARGS = -DCMAKE_TOOLCHAIN_FILE=$(PROJECT_ROOT)/qnx.nto.toolchain.cmake \
             ...
             -DCMAKE_INSTALL_PREFIX=$(LIBSSH2_INSTALL_ROOT)/$(PREFIX) \
             -DCMAKE_INSTALL_LIBDIR=$(LIBSSH2_INSTALL_ROOT)/$(CPUVARDIR)/$(PREFIX)/lib \
             -DCMAKE_INSTALL_BINDIR=$(LIBSSH2_INSTALL_ROOT)/$(CPUVARDIR)/$(PREFIX)/bin \
